...
var particleCount = 95,
  ...
  tilt = 0.04,
  color = "#FFEED4",
  particleSizeBase = 0.03,
  particleSizeMultiplier = 0.6,
  flareSizeBase = 80,
  flareSizeMultiplier = 80,
  lineWidth = 0.8,
  linkChance = 50, //lower = higher chance of particle link
  linkLengthMin = 3, //min points of links
  linkLengthMax = 5, //max points of links
  linkOpacity = 0.3; // 0 - 1
(linkFade = 55), // link fade-out frames
  ...
  (renderMesh = false),
  (flicker = true),
  (flickerSmoothing = 25), //star flickerings
  (blurSize = 0),
  (orbitTilt = true),
  (randomMotion = true),
  (noiseLength = 1000),
...
function init() {
  ...
  //Renders flares depending on count
  if (renderFlares) {
